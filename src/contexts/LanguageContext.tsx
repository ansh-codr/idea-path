...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "cta.save": "Save & Continue",
    "cta.restart": "Try Different Inputs",
    "cta.features.title": "What you get with IdeaForge",
    ...
    // Footer
    "footer.tagline": "Built with intelligence. Designed for dreamers.",
    "footer.disclaimer": "IdeaForge © 2026 • AI outputs are suggestions, not guarantees",
    
    // Chatbot
    "chat.title": "IdeaForge Assistant",
  ...
  hi: {
    ...
    "cta.save": "सहेजें और जारी रखें",
    "cta.restart": "अलग इनपुट आज़माएं",
    "cta.features.title": "IdeaForge के साथ आपको क्या मिलता है",
    ...
    // Footer
    "footer.tagline": "बुद्धिमत्ता के साथ बनाया। सपने देखने वालों के लिए डिज़ाइन किया गया।",
    "footer.disclaimer": "IdeaForge © 2026 • AI आउटपुट सुझाव हैं, गारंटी नहीं",
    
    // Chatbot
    "chat.title": "IdeaForge सहायक",
  ...
  ta: {
    ...
    "cta.save": "சேமித்து தொடரவும்",
    "cta.restart": "வேறு உள்ளீடுகளை முயற்சிக்கவும்",
    "cta.features.title": "IdeaForge-ல் உங்களுக்கு என்ன கிடைக்கும்",
    ...
    // Footer
    "footer.tagline": "அறிவுடன் கட்டப்பட்டது. கனவு காண்பவர்களுக்காக வடிவமைக்கப்பட்டது.",
    "footer.disclaimer": "IdeaForge © 2026 • AI வெளியீடுகள் பரிந்துரைகள், உத்தரவாதங்கள் அல்ல",
    
    // Chatbot
    "chat.title": "IdeaForge உதவியாளர்",
  ...
  te: {
    ...
    "cta.save": "సేవ్ చేసి కొనసాగించు",
    "cta.restart": "వేరే ఇన్‌పుట్‌లు ప్రయత్నించండి",
    "cta.features.title": "IdeaForge తో మీకు ఏమి లభిస్తుంది",
    ...
    // Footer
    "footer.tagline": "తెలివితేటలతో నిర్మించబడింది. కలలు కనేవారి కోసం రూపొందించబడింది.",
    "footer.disclaimer": "IdeaForge © 2026 • AI అవుట్‌పుట్‌లు సూచనలు, హామీలు కాదు",
    
    // Chatbot
    "chat.title": "IdeaForge సహాయకుడు",
